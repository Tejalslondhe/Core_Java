...
import static com.utils.OrderUtils.checkOrderStatusById;
import static com.utils.OrderUtils.orderPet;
import static com.utils.OrderUtils.updateOrderStatus;
import static com.utils.PetUtils.addNewPet;
import static com.utils.PetUtils.displayAllPets;
import static com.utils.PetUtils.updatePetDetails;
import static com.utils.UserUtils.login;
			...
			do {
				...
				try {
					...
					case 7:
						...
						break;
					case 8:
						pets.sort(Comparator.comparing(Pet::getUnitPrice));

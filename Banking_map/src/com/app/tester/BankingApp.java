			...
			while (!exit) {
				...
				System.out.println(
						"Options : 1. Create A/C \n" + "2. Display All Accounts \n" + "3. Display account summary \n"
								...
								+ "10. Display A/Cs  sorted by DoB  \n" +"11. sort acct details as per asc order of dob n balance(desc) \n"
								+ "12.sort acct details as per desc order of dob of a/c holder , using anonymous\n"
								+ "0. Exit ");
				...
				try {
					...
					case 8:// sort acct details as per asc order of acct nos (Natural Ordering)
							// since sorting criteria : acct no --key based --TreeMap(Map map)
					...
					case 10: // sort acct details as per asc order of dob
						List<BankAccount> list1 = new ArrayList<>(accounts.values());
						Collections.sort(list1, new BankAccountDobComparator());
						for(BankAccount a : list1)
							System.out.println(a);
						break;
						
						
					case 11: // sort acct details as per asc order of dob n balance(desc)
						List<BankAccount> list2 = new ArrayList<>(accounts.values());
						Collections.sort(list2, new BankAccountDobBalanceComparator());
						break;
					case 12: // sort acct details as per desc order of dob of a/c holder , using anonymous
						...
						// Comaprator
						List<BankAccount> list3 = new ArrayList<>(accounts.values());
						Collections.sort(list3, new Comparator<BankAccount>() {
